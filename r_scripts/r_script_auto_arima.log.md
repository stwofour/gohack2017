...
```
![ACF on Diff](https://www.dropbox.com/s/7qcvli05tkvdnhz/ACF%20on%20Diff.png?dl=0)


```
> pacf(rides.xts.train.diff1, lag.max=20, na.action = na.omit)
```
![PACF on Diff](https://www.dropbox.com/s/4melg38uz6gbid9/Partial%20ACF%20on%20Diff.png?dl=0)
...
```
![ACF on Forecast Residuals](https://www.dropbox.com/s/paa4z9uoqcxwcas/ACF%20on%20Forecast%20Residuals.png?dl=0)
...
```
![ForecastErrors](https://www.dropbox.com/s/hwcu5z7rsqhs1ip/Histogram%20of%20Forecast%20Errors.png?dl=0)
